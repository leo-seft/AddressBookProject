...
namespace TaskManagement
{
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case 4:
                        ...
                        {
                            var contactToDelete = addressBook.GetContactById(deleteId);
                    ...
                    case 5:
                        ...
                        return;
                    case 6:
                        Console.Write("Enter the ID of the contact to find: ");
                        int.TryParse(Console.ReadLine(), out int findId);
                        Contact retrivedContact = addressBook.GetContactById(findId);
    ...
    public class AddressBook
    {
        ...
        public void CheckDatabase()
        {
            ...
            try
            {   //checks database connects successfully
